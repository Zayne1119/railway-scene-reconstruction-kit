...
from railway_recon.supplemental_platform_clock import build_supplemental_platform_clock


def main() -> int:
    parser = argparse.ArgumentParser(description="Build one evidence-fitted hanging platform clock.")
    ...
    parser.add_argument("--point-evidence", required=True, type=Path)
    parser.add_argument("--photo-evidence", required=True, type=Path)
    parser.add_argument("--output-dir", required=True, type=Path)
    args = parser.parse_args()
    outputs = build_supplemental_platform_clock(
        ...
        point_evidence_path=args.point_evidence,
