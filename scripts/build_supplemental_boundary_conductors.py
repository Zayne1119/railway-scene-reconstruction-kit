...
from railway_recon.supplemental_boundary_conductors import (
    build_supplemental_boundary_conductors,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build point-supported conductors that continue into the next segment"
    )
    ...
    outputs = build_supplemental_boundary_conductors(
