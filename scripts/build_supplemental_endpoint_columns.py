...
from railway_recon.supplemental_endpoint_columns import (
    build_supplemental_endpoint_columns,
)


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build three point-confirmed missing canopy endpoint columns."
    )
    ...
    outputs = build_supplemental_endpoint_columns(
